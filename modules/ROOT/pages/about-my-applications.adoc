...
Requesting access creates an API contract with the client credentials for a
registered client application. API contracts are visible to API consumers in
Exchange, and visible to API providers in API Manager.
