...
applications that hold a contract between a user and an API or an API Group.
...
API or API Group instance. An API consumer can use Exchange's *My Applications* page to view
