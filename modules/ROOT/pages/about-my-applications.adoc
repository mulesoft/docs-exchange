...
Manage your client applications using the *My Applications* page. This page lists applications that hold a contract with an API or an API group. To view this page, select *My applications* from the navigation bar.
