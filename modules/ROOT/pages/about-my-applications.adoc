...
To see your client applications from Exchange, select *My application* from the navigation bar and select an application from the list.
...
== Add an SLA Tiers
SLA tiers are defined in API Manager. If an application does not have an SLA tier listed, you can request to add an SLA tier. The instance owner must approve the tier.
...
. Click *Manage SLA Tiers*.
. Select a SLA tier and click *Submit*.
