...
For _Connected Apps_, the experience is slightly different. If an asset is created through a connected app with this scope, the Asset Administrator role will be granted to the connected app's owner. This means that you can not use Connected Apps with Excahgen Creator scope to create new versions of existing assets.
