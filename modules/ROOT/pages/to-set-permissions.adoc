...
You can remove Project Administrator roles using the request below. This is useful when the role limit has been reached.
...
The identity_ids value in the request body is the userId. The rest of the values used in the body refer to the role you want to remove. To identify the role data, retrieve existing roles using the following request:
