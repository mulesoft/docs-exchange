...
Remove roles including the Project Administrator role when you reach the limit. Project Administrator is an internal role included in the Exchange Contributor permission.
