...
To control access to assets in a business group, add users or teams to Exchange permissions role groups.
...
To control access to individual assets, add users or teams to asset permissions role groups.

The following permissions extend access on assets in addition to the permissions that a user has at the business group level:
