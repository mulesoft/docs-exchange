...
Remove roles, including Project Administrator, when you reach the limit. Project Administrator is a built-inrole included in the Exchange Contributor permission.
