...
* Exchange Administrator: This role group gives permission to users to view, create, and download assets within a business group. Users with this role group can do everything that the Exchange Contributor and Exchange Viewer roles can do plus share an asset with another user, deprecate an asset, and delete an asset. Use this role to set up Exchange Administrator for all the assets within a specific business group.
...
* Asset Administrator: This role gives permission to users to view, create, download, deprecate, and delete an asset. Users with this role can do everything the Exchange Administrator role can do on a single asset only. This role is assigned by default to an asset creator. Use this role to extend administrator permissions on an asset to an additional user.
