...
image::ex-metrics-dashboard.png["The dashboard of usage and engagement metrics for the ten most recent REST APIs."]
...
+
image::ex-my-organizations.png["Filter options for My Organizations.",15%,5%]
