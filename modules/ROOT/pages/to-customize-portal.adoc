...
The option to use a third party identity provider (IdP) such as Okta can be added with Anypoint Platform xref:access-management::external-identity.adoc[identity management].
