...
Users can always access an organization's Exchange public portal with the Anypoint Platform login.

The option to use a third party identity provider (IdP) such as Okta can be added to the login page with Anypoint Platform xref:access-management::external-identity.adoc[identity management].
...
The public portal customization for the organization's branding applies to the login page, including background color, text color, active text color, and a custom logo.
