...
* When creating a REST API snapshot version, the REST Connectors generated from it, will be snapshot versions too.
...
* Asset version dependencies, tags, permissions and any other asset metadata won't be modified when the version is re-published.
...
* If the asset is a REST API, the OAS or RAML translation will be translated again and the REST Connectors will be generated again too.
