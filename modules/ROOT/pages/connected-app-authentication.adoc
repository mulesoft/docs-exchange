...
The connected application allows access to Exchange using the client application credentials. It won’t be necessary to send a token to execute the Exchange requests, only using the Client Id and Client Secret credentials will be enough.
