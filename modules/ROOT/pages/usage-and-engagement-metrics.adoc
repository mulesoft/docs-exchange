...
Exchange provides usage and engagement metrics for administrators and asset owners to gain insight into the consumption and user engagement of their API specification fragments and REST API assets. 

The usage metrics measure:

* The number of times the asset was downloaded from Exchange.
* The number of times the asset was imported from API Designer.
* The number of times the asset was imported from Anypoint Studio.
