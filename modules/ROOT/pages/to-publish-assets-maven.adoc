...
:page-notice-banner-message: <b>Important:</b> Starting May 18, 2026, publishing connectors and Mule plugins to Exchange requires mule-extension-plugin version 1.9.0 or higher. See <a href="#connector-publishing-requirements">Connector Publishing Requirements</a>.
