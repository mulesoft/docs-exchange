...
Your POM file must include the required plugin `org.mule.tools.maven.mule-maven-plugin`. Do not include the plugin `org.apache.maven.plugins.maven-deploy-plugin` in your POM file or settings file, because it is not compatible with the required plugin.
