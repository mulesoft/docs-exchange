...
Starting May 18, 2026, connectors and Mule plugins published to Exchange require `mule-extension-plugin` version 1.9.0 or later. This version includes Java compatibility information in your asset's `mule-artifact.json` file.
