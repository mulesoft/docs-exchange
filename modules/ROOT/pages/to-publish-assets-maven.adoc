...
+
. In your project's POM file, add the asset type in the properties section.
+
For example:
+
[source,xml,linenums]
...
+
----
https://anypoint.mulesoft.com/exchange/api/v3/assets/ORGANIZATION_ID/ASSET_ID
----
+
Replace ORGANIZATION_ID with the Exchange's organization ID and replace ASSET_ID with the asset ID.
+
In the EU, use:
+
----
https://eu1.anypoint.mulesoft.com/exchange/api/v3/assets/ORGANIZATION_ID/ASSET_ID
----
