...
:page-notice-banner-message: <b>Important:</b> Starting May 18, 2026, publishing connectors and Mule plugins to Exchange requires `mule-extension-plugin` version 1.9.0 or later. Update your plugin version before publishing new connector versions. See <a href="#update-plugin-exchange-publishing">Update Your Plugin for Exchange Publishing</a>.
...
* If you use the parent POM, update to the latest parent POM version that includes `mule-extension-plugin` 1.9.0 and later.
* If you use Mule SDK, upgrade to a version that includes `mule-extension-plugin` 1.9.0 and later.
