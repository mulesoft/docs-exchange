...
[IMPORTANT]
====
Starting May 18, 2026, custom connectors and Mule plugins published to Exchange require `mule-extension-plugin` version 1.9.0 or higher. This change doesn't affect connectors already published to Exchange.
