= Migrating Assets from Exchange 1
...
* https://www.youtube.com/watch?v=BOAR9glreMw&feature=youtu.be[Migrate SOAP Assets Video]
* https://www.youtube.com/watch?v=WTIJrYydViQ&feature=youtu.be[Migrate RAML REST Assets]
