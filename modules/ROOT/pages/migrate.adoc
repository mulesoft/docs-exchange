= Migrating Assets from Exchange 1 to Exchange 2
...
* https://youtu.be/BOAR9glreMw[Migrating SOAP Assets Video]
* https://youtu.be/WTIJrYydViQ[Migrating RAML REST Assets]