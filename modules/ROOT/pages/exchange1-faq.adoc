...
Note: When you create a category, you must be in the root organization. If you create a category in a business group, the category does not appear.
...
Users must be assigned to the Exchange Viewer role. Users can view the root organization without being assigned to the Exchange Viewer role, but not business groups. If users are invited to a business group, they won't see other business groups until assigned Roles access.
