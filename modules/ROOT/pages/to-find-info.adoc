...
The options that appear depend on which types are available within an organization. 
...
The sorting options that appear depend on which types are available within an organization.
