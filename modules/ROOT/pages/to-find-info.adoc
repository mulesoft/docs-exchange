...
You can use filters to refine your search results to find assets. You can filter using the following options:

image:ex-filters.png[Filters]
...
image:ex-sort-by-filter.png[Sort by filter]
