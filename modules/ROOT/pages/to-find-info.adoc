...
The Exchange catalog of assets can display hundreds of assets that help developers discover assets to create projects quickly and drive adoption of best practices and reuse. You can find assets from Mulesoft's ecosystem or your own organization. Based on your permission group, you can search multiple business groups, documentation, tags, custom attributes, and details from API specifications. To help find assets, searches can be refined using search terms like a name of an API, by filters like organizations, categories, tags, and lifecycle states, or by ranking.
...
Use the *Search assets* field to find assets by keyword.
...
* Endpoints in the API specification
* Description of API specification (summary or API title)
...
Use filters to refine your search results to find assets. You can filter using the following options:
...
Filter options appear if they are available within an organization. 
...
* Featured
+
Sorts by placing a featured selection of assets at the top of the results. Other assets that are not featured assets are ordered by last modified.

The sorting options appear if they are available within an organization.
