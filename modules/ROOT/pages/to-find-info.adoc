...
Use preset operators to filter the search results. The values of the operators can be changed and customized. For example, you can add a specific date using a defined format (YYY-MM-DD). The customized value shows in the list of options as freeform.
