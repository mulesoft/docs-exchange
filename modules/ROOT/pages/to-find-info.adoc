...
In Exchange Private Cloud Edition and GovCloud, searches only apply to the Exchange organization you are viewing. If you search in a private Exchange organization, the search only lists that organization's assets and not MuleSoft's public assets.
...
If you separate search words with any non-alphanumeric character other than a space, Exchange
