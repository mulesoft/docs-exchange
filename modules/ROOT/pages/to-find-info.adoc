...
If you cannot find an asset in one group, it may be in another business group, or click *Assets* to search other assets. The left navigation area provides additional areas to search. The MuleSoft scope lists assets provided by MuleSoft.
