...
When you publish an agent network project to Exchange, it creates and updates the assets contained in the project and automatically tags brokers for easy identification. 
