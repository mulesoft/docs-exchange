...
For Agent Fabric, agent network projects created in Anypoint Code Builder are published to Exchange as A2A assets. Exchange automatically tags these assets as brokers. 
