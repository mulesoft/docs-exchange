...
Asset administrators, Exchange administrators, and organization owners have authorization to deprecate an asset. Set these permissions in Anypoint Access Management.
