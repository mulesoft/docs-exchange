...
Add a scanner to discover, import, and sync agents from AWS Bedrock AgentCore into Exchange. Then you can govern the agents and consume them in other applications.

== Before You Begin

This setup requires specific configurations and access privileges in AWS Bedrock to enable the scanner to access and list AWS Bedrock AgentCore agents.
