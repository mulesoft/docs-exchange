...
* Microsoft Azure Copilot System Administrator/System Customizer role (assign the app user and security role in Power Platform before configuring the scanner).
