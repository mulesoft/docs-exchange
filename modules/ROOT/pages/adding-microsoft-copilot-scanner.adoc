...
* Microsoft Azure Copilot System Administrator/System Customizer role (Before configuring the scanner, assign the app user and security role in Power Platform).
