...
To configure Microsoft Copilot Studio before you add a scanner, review these high-level steps. For details, see the https://learn.microsoft.com/en-us/microsoft-copilot-studio/[MicrosoftCopilot Studio documentation].
