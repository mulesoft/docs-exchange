...
Exchange asset versions follow the https://semver.org/[Semantic Versioning] model of major, minor, and patch releases. For example, if an asset is version 2.4.6, its major version is 2.x.x, its minor version is 2.4.x, and its patch version is 2.4.6.
