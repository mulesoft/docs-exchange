...
For RAML and OAS API specifications within Exchange, change the version number from within Exchange using the *Add version* button. You can also change the version using the *Manage versions* button. See "Manage Versions" for more information.
...
Select a minor asset version to edit with the menu next to the API name.

image::ex-title-version-setting.png[The minor version selection menu]
