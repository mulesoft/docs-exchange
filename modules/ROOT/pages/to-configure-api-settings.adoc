...
. Enter the instance name, URL, and select a visibility option and click the checkmark.
. To edit a non-managed instance:
.. Click the pencil icon:
.. Make your changes and click the checkmark icon.
. To delete a non-managed instance, click the trash can icon.
