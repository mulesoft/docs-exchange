...
. In the *Non-managed instances* section, enter the instance name and URL. 
. Select a visibility option and click image:ex-checkmark-icon.png["The checkmark icon.",3%,3%].
...
* Delete a non-managed instance by clicking image:ex-trash-can-icon.png["The trash can icon",3%,3%] and then clicking *Delete instance*.
