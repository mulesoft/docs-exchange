...
Configure assets with instances not managed by API Manager. Add, edit, and delete non-managed instances that are serving AsyncAPIs, GraphQL, REST, HTTP APIs, agents, MCPs, and LLMs. You can change the name, URL, and visibility of non-managed instances an services.
