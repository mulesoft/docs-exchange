...
After you register an API or other asset from Exchange in API Manager, the instances for the asset appear in Exchange in the *Instances* list on the asset details page. 

You can also verify agent instances via GoDaddy Agent Naming Service (ANS) during the registration process in API Manager. Implement GoDaddy's trust layer to verify and secure trusted agents across Anypoint Platform. Verified agents display in the *Agents & Tools* list and on asset details pages with a verified badge. Managed instances in Exchange show if an agent is verified in the *Instances* list on the asset details page.
...
* xref:api-manager::godaddy-ans-registration.adoc[]
* xref:asset-details.adoc#view-instances[View Instances]
