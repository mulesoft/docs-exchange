...
Add a scanner to discover, import, and sync agents from Azure API Management into Exchange. Then you can govern the agents and consume them in other applications.
...
|*Tenant ID* |Enter the access key ID.
|*Client ID* |Enter the secret access key.
