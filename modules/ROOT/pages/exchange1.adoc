...
[NOTE]
This page describes Exchange 1, which is a legacy product. We recommend that all users xref:migrate.adoc[migrate] to the current version, xref:exchange/index.adoc[Exchange 2].
