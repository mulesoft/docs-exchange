...
If you use the January 2015 - Update Site 1 version of Anypoint Studio or later, exporting your project already produces a zip file that has the necessary structure. To expose your Mule Project on  Exchange:
