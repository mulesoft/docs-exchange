...
+
Templates for RPA processes that can be imported into RPA Builder as projects and can be further customized before deploying to RPA bots. Process templates are built on common patterns for RPA to build automation faster. File type is .crpa. 
