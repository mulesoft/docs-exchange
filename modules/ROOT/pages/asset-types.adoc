...
* A2A Agents
+
AI agents use the Agent2Agent (A2A) Protocol to communicate and collaborate with each other to perform tasks.
...
* MCP Servers
+
Application or APIs exposed through the Model Context Protocol (MCP). MCP is an open protocol designed to standardize how applications provide context and capabilities to Large Language Models (LLMs) and AI agents. Contains files, database schemas, application-specific information in a  JSON file.
