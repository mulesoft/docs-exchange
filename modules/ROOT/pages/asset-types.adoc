...
* GraphQL API 
+
A schema definition that contains the object and types definitions that are used to interact with the API through the GraphQL specification. GraphQL enables you to query an API that supports this language in a much more flexible way than REST.
* HTTP APIs
+
