...
+
When agent network projects created in Anypoint Code Builder are published to Exchange, the individual agentic assets defined in the file are registered as either agents or MCP servers. Brokers, which are published with the Agent asset type, are automatically tagged as brokers for easy identification.
