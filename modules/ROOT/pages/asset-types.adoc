...
+
Agent network projects created in Anypoint Code Builder are published to Exchange as agent assets. Exchange automatically tags these assets as brokers for easy identification. 
...
* LLM 
+
Large language models (LLM) are AI assets for processing, understanding, and generating human readable language. Only OpenAI is supported.
