...
* MCP Servers
+
Application or APIs exposed through the Model Context Protocol (MCP). MCP is an open protocol designed to standardize how applications provide context and capabilities to Large Language Models (LLMs) and AI agents. 
