...
+
An AsyncAPI specification file that specifies an event-driven API. Exchange supports AsyncAPI 2.0 and 2.6.
* Connectors
+
...
* Mule Applications
+
Applications that perform system integrations. These applications are published and consumed using APIs and don't appear in the Exchange UI, catalog, or search results. Use the Exchange Maven Facade API or REST API to make calls to Mule applications. 
+ 
