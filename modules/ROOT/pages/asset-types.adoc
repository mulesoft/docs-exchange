...
+
An AsyncAPI specification file that specifies an event-driven API. Exchange supports AsyncAPI 2.0 and 2.6. AsyncAPI 2.6 supports specs with Avro schemas. The file types for AsyncAPIs with Avro schemas are JSON and AVSC.
* Connectors
+
