...
* Run the `api-catalog conf` command with the options you want to use to set the authentication method. For example, the following command sets the username and password.
+
----
...
$ api-catalog conf organization myOrgId
----
+
