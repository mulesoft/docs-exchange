...
----
This command accepts the xref:use-api-catalog-cli.adoc[common options] in addition to the following options:

[%header,cols="20a,80a"]
|===
| Option | Description 
| blank | Install autocompletion using the default shell settings
| bash | Install autocompletion using bash shell settings
| zsh | Install autocompletion using zsh shell settings
...
This command accepts the xref:use-api-catalog-cli.adoc[common options] in addition to the following option: 
