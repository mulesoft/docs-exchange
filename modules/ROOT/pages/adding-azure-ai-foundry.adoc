= Adding a Scanner for Azure AI Foundry
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Add a scanner to discover, import, and sync agents from Azure AI Foundry into Exchange. Then you can govern the agents and consume them in other applications.

== Before You Begin
This setup requires specific configurations and access privileges within the Azure environment to enable the agent scanner to access and list Azure Foundry AI agents.
...
+
The following values, obtained during the Azure App registration setup, are required for scanner configuration:
+
...
== Add a Scanner for Azure AI Foundry
