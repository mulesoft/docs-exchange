...
- the password should be defined as: `clientId\~?~clientSecret`

To specify the connected app authentication, define it as an authorization field in the Query Variables

image::ex2-connect-app-graph.png[Screenshot - Connected App Authentication]


To see how to create and configure your Connected Application please visit 
xref:connected-app-authentication.adoc[Create a Connected App]
