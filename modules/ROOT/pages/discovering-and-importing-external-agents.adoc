...
Agents added by scanners generate read-only, system-level credentials. The system stores sensitive material, such as API keys and tokens, securely stored in Anypoint Security secrets manager. 
...
* Retrieval: 10,000 agents per runtime
* Runtime: 6 hour
