...
Scanners add supported agents to *Agents & Tools* as agent asset types. They detect new agents, identify metadata updates, flag missing agents, and provide a side-by-side comparison of changes. Subsequent scans overwrite metadata changes and restore agents deleted from Exchange. To retain changes, update the asset in the agent provider‘s source.
...
* Retrieval: 1,2000 agents per runtime limit
* Runtime: 6 hours
+
