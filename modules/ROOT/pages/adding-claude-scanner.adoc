...
Add a scanner to discover, import, and sync agents from Anthropic Claude Managed Agents into Exchange. Then you can govern the agents and consume them in other applications.
...
|*Platform* |Select *Claude Managed Agents*.
