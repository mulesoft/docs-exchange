...
Add a scanner to discover, import, and sync agents from Google Apigee into Exchange. Then you can govern the agents and consume them in other applications.
