...
Add a scanner to discover, import, and sync services from Google Apigee into Exchange. Once imported, these services are available for governance, policy enforcement, and exposure through your developer portal.
