...
If the instance is public, then the portal always displays the *Request Access* button. If a logged out user requests access, then Exchange prompts them to log in.
