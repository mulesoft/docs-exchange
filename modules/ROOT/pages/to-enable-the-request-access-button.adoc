= Enabling the Request Access Button
...
Exchange Administrators see *Request access* in the *More options* menu image:ex2-more-options-icon.png["The More Options icon"].
