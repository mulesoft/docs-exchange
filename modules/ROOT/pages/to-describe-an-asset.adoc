...
+
_Note: Before the June 2019 release, individual asset versions could have different names. After the June 2019 release, changing the asset name will impact all asset versions._
...
To cancel the changes, click on the cancel icon.
+
_Note: Before the June 2019 release, individual asset versions could have different names. After the June 2019 release, changing the asset description will impact all asset versions._
...
+
_Note: Before the June 2019 release, individual asset versions could have different names. After the June 2019 release, changing the asset icon will impact all asset versions._
