...
+
. This action change the name of all asset versions
...
To cancel the changes, click on the cancel icon.
+
. This action change the description of all asset versions
...
+
. This action change the icon of all asset versions
