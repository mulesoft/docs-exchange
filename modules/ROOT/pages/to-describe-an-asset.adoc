...
All versions of an asset have the same name, icon, description, and computed average rating. Each minor version of an asset has its own ratings and reviews, tags, categories, custom fields, and content pages, including an optional page of terms and conditions.
