...
. In the asset details pane, click *Add categories*. 
. Select from the list of categories. You can add up to X categories.
. Click *Add value*.
. Select from the list of values. You can add up to X values to add more categories and values.
...
When searching for assets, tags can be used to filter the search results 
...
. In the asset detail pane, click *Add tags*.
. Enter the new tag.
. Press the enter or return key on your keyboard. You can enter X amount of tags.
. To remove a tag, select the *X* next to the tag text.
...
. Select *Edit documentation*.
. In the left navigation pane, click *Add New Page*. 
...
. To save a draft of a new page, select *Save*. Secondary pages are listed in the left navigation bar.
. To edit a draft, select the name of the page from the list in the right navigation pane and click *Edit*
. To cancel your edits, click *Cancel*.
. After you edit and save all your pages, select *Publish* for each page that you want to publish.
