...
image::ex2-exchange-click-on-asset.png[Illustration - Click on asset in Exchange]

To enter in an asset portal, click in the asset.

image::ex2-exchange-asset-portal-empty.png[Illustration - Asset Portal]
...
image::ex2-exchange-click-on-edit-name.png[Illustration - Edit asset name]
...
image::ex2-exchange-click-on-edit-description.png[Illustration - Edit asset description]
...
image::ex2-exchange-click-on-edit-icon.png[Illustration - Edit asset icon]
...
image::ex2-exchange-click-on-add-asset-tag.png[Illustration - Add asset tags]
...
image::ex2-exchange-click-on-edit-asset-portal.png[Illustration - Edit asset portal]
