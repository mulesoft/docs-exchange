...
If any of the APIs in an API group have a terms and conditions page, then the API group has a terms and conditions page that cannot be deleted and shows all the terms and conditions of the underlying APIs.

You may optionally add more terms and conditions to the API group's terms and conditions page.
