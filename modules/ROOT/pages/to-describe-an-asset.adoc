...
You can edit an asset's portal, change its name, icon, description, and tags, and add portal pages with content.

In Exchange, open the asset list and select the asset. Exchange shows the asset portal.

== Edit Asset Name

. Select the asset name or the pen icon after the asset name.
...
NOTE: Before the August 2019 release, the versions of an asset could have different names. After the August 2019 release, a new asset name applies to all versions of the asset.
...
NOTE: Before the August 2019 release, the versions of an asset could have different descriptions. After the August 2019 release, a new asset description applies to all versions of the asset.
