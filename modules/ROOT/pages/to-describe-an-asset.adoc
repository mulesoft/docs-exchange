...
Once an asset has been created, you can edit its portal, changing its name, description and adding portal pages with content.
...
This is an example of an asset portal.
