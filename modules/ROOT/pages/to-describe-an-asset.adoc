...
Pages created before the September 2021 update have URLs with no page ID, such as `pages/Messages`. Changing the page name from *Messages* to *Messaging* changes the URL to the new format, such as `pages/de4-56f/Messaging`, and the old URL automatically redirects to the new URL.
