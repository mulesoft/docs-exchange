...
When you request access to an API group, the least restrictive available contract is applied. The application uses that contract to access the API group instance.
