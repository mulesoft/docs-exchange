...
When you request access to an API Group, the least restrictive available contract for each API is applied. The application uses that contract to access the API Group instance.
