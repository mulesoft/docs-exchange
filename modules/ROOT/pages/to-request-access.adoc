...
When you request access to an API group, Exchange automatically compares all available contracts and applies the least restrictive contract. The application uses that contract to access the API group instance.
