...
A client application's owners and an API instance owner have permission to request access for that client application.
For access to a client application created by another user, request access from either the client application owner or the API instance owner.
to add your user account to the application owners list in Anypoint API Manager.
