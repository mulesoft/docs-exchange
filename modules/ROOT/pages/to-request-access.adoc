...
In Exchange, agents, LLMs,and MCP server are assets with a portal. The *Instances* page on the portal lists all of the assets's instances.
...
. If the instance has an SLA tier, a notification dialog shows that your request is revieced and pending. You'll be notified by email the status changes. You can also check the status on the application page.
== See Also
