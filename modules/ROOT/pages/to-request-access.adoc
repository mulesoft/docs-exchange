...
A client application's owners have permission to request access for that client application.
To request access for a client application created by another user, ask the client application owner
