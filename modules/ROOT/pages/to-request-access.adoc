...
+
Some external authentication providers offer only some of these grant types.
+
** If Exchange should automatically register the redirect URIs for API Notebook and API Console.
