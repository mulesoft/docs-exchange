...
As an Exchange administrator, you can edit the description of your organization's asset so that users outside the organization can identify it, and then share that asset by publishing to a public portal:
