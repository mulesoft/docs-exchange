...
Exchange public portals are accessible to anyone using the internet, enabling developers outside of an organization to access that organization's REST, SOAP, and HTTP APIs.
...
As an Exchange administrator, you can edit the description of your organization's API asset so that users outside the organization can identify it, and then share that asset by publishing to a public portal:
