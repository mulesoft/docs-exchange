...
Exchange public portals are accessible anyone using the internet, enabling developers outside of an organization to access that organization's REST, SOAP, and HTTP APIs. Users who are not logged in can download assets from public portals.
