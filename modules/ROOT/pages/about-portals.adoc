...
All Organizational Public Portals in Exchange created after July 2022 are disabled by default, so you can't sign in to view assets or share new assets on your Public Portal unless you enable them.
