...
== Set the status of your organization Public Portal

The public portals in Exchange of all organizations are disabled by default, that is, they cannot be used unless you reactivate them.
...
To start using your organization's Public Portal and sharing assets as public you must enable your Public Portal as follows:
...
Once all the assets of your organization have been marked as private, you must make the following request:
