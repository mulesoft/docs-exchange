...
----
====
MuleSoft uses a customized version of the official MCP schema. While it shares definitions with the standard specification, the implementation is unique to MuleSoft.
