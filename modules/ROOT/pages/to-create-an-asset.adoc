...
MuleSoft recommends deleting all old Custom assets containing files of types that are no longer permitted. Users can delete those assets directly from Exchange.
