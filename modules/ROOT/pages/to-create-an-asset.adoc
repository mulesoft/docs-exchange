...
image::ex2-exchange-create-new-asset-form.png[Illustration - Create a new asset form]
...
image::ex2-exchange-advance-settings-form.png[Illustration - Advance Settings]
...
image::ex2-exchange-create-api-asset.png[Illustration - Advance Settings]
...
image::ex2-exchange-create-new-asset-version.png[Illustration - Create new asset version]
