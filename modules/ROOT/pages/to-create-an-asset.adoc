...
image::ex2-exchange-create-new-asset-form.png[Illustration - Create a new asset form][height=400,width=700]
...
image::ex2-exchange-advance-settings-form.png[Illustration - Advance Settings][height=400,width=700]
...
image::ex2-exchange-create-api-asset.png[Illustration - Create API Asset][height=900,width=500]
...
image::ex2-exchange-create-custom-asset.png[Illustration - Create API Asset][height=900,width=500]
...
image::ex2-exchange-click-on-asset.png[Illustration - Click on asset in Exchange][height=400,width=700]
