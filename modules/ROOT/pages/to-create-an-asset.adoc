...
An AsyncAPI is an AsyncAPI specification file that specifies an event-driven API. You can create AsyncAPIs with Avro schemas. The file type for AsyncAPIs with Avro schemas is  AVSC (.avsc).
