...
If you create an agent using *Other* as the protocol type, the file must be json file. This card follows the structure of the A2A Spec without required properties.
...
It's possible to have more than one LLM assets in your organization.
