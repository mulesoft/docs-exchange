...
Once the set up for your vanity domain is done and the site is up and running, you need to activate cookie consent management by contacting customer support with this information:
