...
`+https://developers.robocop.com/exchange/api-console-components+` needs to be rerouted to `+https://anypoint.mulesoft.com/exchange/api-console-components+`
...
----
‘X-Forwarded-Path’: Base path of your vanity domain public portal URL.
This can be anything (including just / for root path), it doesn't need to match the base path for the portal in anypoint.mulesoft.com domain. This path must end with a slash “/“. Eg: ‘path/of/justice/’
‘X-Forwarded-Host’: your public portal vanity domain, Eg ‘developers.robocop.com’
----
