...
Set up static resource route mapping for `shared`, `icons`, `exchange/api-console-components`, and `node_modules`. Regardless of your portal path, these routes need to be at the root level.

For example:

* Re-route `+https://developers.robocop.com/shared+` to `+https://anypoint.mulesoft.com/shared+`.
* Re-route `+https://developers.robocop.com/icons+` to `+https://anypoint.mulesoft.com/icons+`.
* Re-route `+https://developers.robocop.com/node_modules+` to `+https://anypoint.mulesoft.com/node_modules+`.
* Re-route `+https://developers.robocop.com/exchange/api-console-components+` to `+https://anypoint.mulesoft.com/exchange/api-console-components+`.
