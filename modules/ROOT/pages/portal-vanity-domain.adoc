...
Exchange keeps a list of approved domains for security, also known as a whitelist. Add your public portal's domain to the list:
...
----
+
. Use the access token to add your custom domain to the list:
+
[source,console]
----
