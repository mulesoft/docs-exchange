= Viewing GraphQL API Schemas and Run Queries
...
image::ex-graphql-console.png["The asset details page showing the GraphQL console"]
...
. From the *Instance selector*, select an available server instance to run the query. If there are no server instances available, the *Execute* button is disabled.
