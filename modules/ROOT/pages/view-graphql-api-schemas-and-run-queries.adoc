...
. Click *Prettier* to improve the formatting of the query objects in the editor. 
. Click *Copy* to copy the query and share with others or save for later.
...
. Click *Copy* to share the results with others.
