...
== Run a GraphQL Query
Use the query editor to write queries in the console without knowing the specific syntax using autocomplete and run them in real-time. The query editor is located in the *Query* panel. 
