...
Anypoint Exchange is your curated catalog of APIs and other assets. Use Exchange to discover, share, and incorporate assets and resources into your applications. Exchange helps you create API developer portals, view and test APIs, simulate data to APIs by using the Mocking Service, create assets, and use API Notebooks to describe and test API functions.
...
== Find More Information on an Asset
