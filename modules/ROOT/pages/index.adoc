...
Assets under the *Provided by MuleSoft* organization are created by MuleSoft and its partners, and are certified by Mulesoft. These assets are publicly available to all customers as well. However, all assets that are created by an organization and published into the organization's instance of Exchange, are private and not visible outside that organization. Customers are responsible for any private assets they publish within their Exchange instance.

== Get Started

. From https://www.anypoint.mulesoft.com/exchange/[Exchange], search for assets. If you know the name of the asset, enter the name in the *Search* field. 
