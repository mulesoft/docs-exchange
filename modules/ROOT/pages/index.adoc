...
You create agent network projects in Anypoint Code Builder to define, validate, and publish brokers, LLMs, and MCP servers to allow agents to use the assets in your Agent Fabric. Anypoint Code Builder publishes agent network projects as assets to Exchange. Exchange tags them as brokers for identification. See xref:code-builder::af-agent-networks.adoc[] in the Anypoint Code Builder documentation. 
