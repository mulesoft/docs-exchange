...
The agent registry in Exchange includes some hosted MCP servers from the https://registry.modelcontextprotocol.io/[official MCP registry]. These assets are tagged as *Provider Managed* in the registry.
