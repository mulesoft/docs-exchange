...
Add AI assets in one of these ways:

* Register them manually.
* Add MCP servers via URL.
* Import agents using scanners.
* Import Agentforce agents from Settings
...
Use Anypoint Code Builder to create agent network projects that define, validate, and publish brokers, large language models (LLMs), and MCP servers. These projects enable agents to use assets in MuleSoft Agent Fabric.

Anypoint Code Builder publishes agent network projects to Anypoint Exchange, where they are tagged as brokers. See xref:anypoint-code-builder::af-agent-networks.adoc[] in the Anypoint Code Builder documentation. 
