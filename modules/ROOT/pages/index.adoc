...
* API Groups - An API Group enables you to bundle your APIs into a single asset. Instead of requesting access to multiple APIs to satisfy a use case, a developer can access the group in one step.
