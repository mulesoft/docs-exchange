...
. Click on an asset to view its description. If you log in to Anypoint Platform, you can download an asset.
...
New content is not published to the earlier version. It is available to assist migration to the current Exchange version documented here.
