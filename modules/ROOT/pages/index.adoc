...
You can find A2A agents and MCP servers in *Agents* and *All assets*. You can discover these assets using the search and filter options.
//screen capture of Agentic tab showing those assets
