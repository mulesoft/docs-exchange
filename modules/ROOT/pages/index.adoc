...
* Syncing MCP servers from the official MCP registry.
+
Exchange automatically discovers, translates, and publishes publicly hosted MCP servers from the https://registry.modelcontextprotocol.io/[official MCP registry]. Exchange tags these assets as *Provider Managed*.
