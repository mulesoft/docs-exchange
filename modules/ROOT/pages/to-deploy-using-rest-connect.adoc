...
If you want to add TLS support to your application, it is a good idea to add it before re-generating the connector so you only have to test your app once. 
