...
== REST Connect Security Scheme Support
...
If the operations defined in your API specification support multiple security schemes, only one will be used. It will be selected following the precedence order shown in the previous list - Basic Authentication first, Digest Authentication last -.
