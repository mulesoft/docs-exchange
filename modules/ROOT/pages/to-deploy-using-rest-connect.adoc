...
REST Connect supports RAML v1.0. If you publish a RAML v0.8 API Specification, you receive an alert email. To have an auto-generated connector, convert your API specification to RAML v1.0.
