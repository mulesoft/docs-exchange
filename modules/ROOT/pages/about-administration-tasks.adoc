...
+
Grant the Exchange Administrator, Contributor, or Viewer permissions to members of your organization, and optionally provide access for individual assets.
