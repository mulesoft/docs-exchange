...
You can delete an asset in the first 7 days of its creation and reuse the asset's same name, group, asset ID, and version. A delete within the first 7 days is known as a _hard delete_.

If you delete the asset after 7 days, you can't reuse the same name, business group name, account ID, and version.
A delete after 7 days is known as a _soft delete_. After 7 days if you want to reuse the asset name,
