...
You can restore assets that were deleted along with their GAV information using this endpoint:

`/api/v2/organizations/:organizationId/softDeleted`

It is not possible to recover deleted assets if their GAV information have been reused by a different asset.
