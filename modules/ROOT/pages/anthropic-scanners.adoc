= Anthropic Platform Scanners
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

When your agents are hosted on Anthropic, use this page to jump to the Exchange scanner setup. Step-by-step instructions are in the linked page.

== Agent Scanners

* xref:adding-claude-scanner.adoc[Add a scanner for Anthropic Claude managed agents]
