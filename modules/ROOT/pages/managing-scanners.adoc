...
+
image:agent-scanner-menu.png["Run Now option in the more options menu"]
...
+
. From the sidebar in Exchange, click *Agent Scanners*.
. Find the scanner in the list, click the more options icon, and then select *Abort Scan*.
...
. From the sidebar in Exchange, click *Agent Scanners*.
. Find the scanner in the list, and then select *Delete Scanner* from the more options menu.
...
+
. From the sidebar in Exchange, click *Agent Scanners*.
. Find the scanner in the list, and then select *Edit Scanner* from the more options menu.
