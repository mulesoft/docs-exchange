...
projects:
  ...
  - ref: api-spec/order-api.exchange.json
  - ref: raml-examples-master/defining-examples/organisation-api.exchange.json
  - ref: raml-examples-master/fragments/datatype/general/api.exchange.json
  - ref: raml-examples-master/libraries/api.exchange.json
  - ref: raml-examples-master/media-types/defaults/api.exchange.json
  - ref: raml-examples-master/media-types/multipart-data/api.exchange.json
----
