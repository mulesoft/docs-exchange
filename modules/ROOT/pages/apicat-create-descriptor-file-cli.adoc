...
=== Add Images through a Descriptor File

You can add images to your APIs by adding a markdown file in the descriptor with a link to an image (.png, .jpg). You can visualize the image in the documentation page created for the Exchange Asset.
...
projects:
  - main: sources/api.raml
    ...
    version: 4.0.0
----
With the `summary.md` file containing an image and a documentation markdown file:
----
...
* No documentation entry in the descriptor catalog pointing to the readme file: the link to move between pages in the Asset's portal doesn't work.
