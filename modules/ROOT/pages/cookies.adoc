...
|amplitude_cookie_test |Session |Functional |
|amplitude_id_7856322d613393b800727439f0954eb9mulesoft.com |3650 days |Functional |
|amplitude_idundefinedmulesoft.com |Session |Functional |
|amplitude_testmulesoft.com |Session |Functional |
