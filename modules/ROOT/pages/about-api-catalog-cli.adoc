...
| triggerConditions | This section enables you to set conditions to restrict the APIs that are published when the `api-catalog publish-asset` command is run with the `--trigger` option.   
