...
- create-descriptor command in order to generate a catalog.yaml file after autodiscovering all API candidates

==== Example 2: xxx

- Catalog Descriptor section clarifying how to set up documentation, contact and other API metadata
