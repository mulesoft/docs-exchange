...
. xref:install-api-catalog-cli.adoc#install-api-cat[Install] the API Catalog CLI.
. xref:configure-api-catalog-cli.adoc#install-api-cat[Configure] required catalog permissions.
. xref:create-descriptor-file-cli.adoc#create-desc-file-cli[Create a descriptor file] to identify the APIs to publish.
. xref:publish-using-api-catalog-cli.adoc#publish-apis[Catalog an asset] using the API Catalog CLI and view it in Anypoint Exchange.
