...
NOTE: To have the APIs autodiscovered and YAML results generated to help you populate the descriptor file, use the +api-catalog publish-asset+ command with the dry-run parameter. See <<Publish APIs Using CLI>>.
