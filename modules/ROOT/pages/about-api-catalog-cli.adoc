...
= Publish APIs to Exchange Using API Catalog CLI
...
API Catalog CLI enables you to automatically publish your API specifications to Anypoint Exchange as they are created and updated as part of your CI/CD processes. 

== What You Can Do With API Catalog CLI

With API Catalog CLI you can:

* Automatically publish API specifications in Exchange using CLI commands. 
...
* Unix or Linux OS terminal support for running CLI commands
