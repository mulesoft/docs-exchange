= Adding a Scanner for Amazon Bedrock AgentCore Runtime
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Add a scanner to discover, import, and sync agents from Agent Runtime into Exchange. Then you can govern the agents and consume them in other applications.
