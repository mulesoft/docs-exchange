...
This setup requires specific configurations and access privileges in AWS Bedrock to enable the scanner to access and list Amazon Bedrock AgentCore agents.
