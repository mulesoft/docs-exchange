...
All organizational public portals in Exchange created after July 2022 are disabled by default. You cannot sign in to view assets or share new assets on your public portal unless you enable them.

To determine of your public portal is enabled or disabled, use the following request:
...
All assets that are shared in the public portal do not require authorization to view the details of an asset or download the specifications.
...
You can disable your public portal if you do not want to have any publicly shared information about your assets. 

To disable your organization's public portal, all the assets that are shared in the public portal must be private. 
...
.. Select the asset in Exchange, click *Share*.
