...
NOTE: The code examples for enabling and disabling a public portal show you how to obtain an access token with Multi-Factor Authentication (MFA) disabled.
...
These code examples show you how to obtain an access token with Multi-Factor Authentication (MFA) disabled."
