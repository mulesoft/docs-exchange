...
. Use API Designer in Anypoint Platform to improve and test your RAML or OAS API specification, and to publish the API specification to Anypoint Exchange.
+
Note: An OAS specification is converted into RAML so you can follow the RAML conventions in the API Notebook.
