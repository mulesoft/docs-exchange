= Document an API With API Notebook
...
. To document a RAML, use the Design Center in Anypoint Platform to improve and test your RAML, and to publish the API to Anypoint Exchange.
+
To document an OAS specification, create a new Exchange asset and choose API Spec - OAS. Note: The OAS specification is converted into RAML so you can follow the RAML conventions in the API Notebook.
...
* xref:1.0design-center::upload-raml-task.adoc[Upload an Existing RAML File to Exchange].
