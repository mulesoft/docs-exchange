= Documenting an Asset Using API Notebook
...
. Click *Edit documentation* and click the API Notebook icon image:ex2-api-notebook-icon.png["API Notebook icon in the editor"] in the editor.
