...
Follow these steps to add an asset to a portal and make it public.

The asset is not deleted and is still available internally.
...
Follow these steps to remove an asset from a portal and make it private.
