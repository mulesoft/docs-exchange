...
You can upload up to 100 resources to a portal. Each image is one resource. Attempting to add more will result in an error. You can delete resources to reduce the number and then add more up to the limit.

This limit applies to asset portals and to the organization's public portal.

These examples show how to list, retrieve, and delete resources from a portal with the Exchange Experience API.
