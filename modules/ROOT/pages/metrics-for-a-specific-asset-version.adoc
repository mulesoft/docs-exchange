...
image::ex-metrics-for-asset-version.png["Assets details page with usage and engagement metrics."]
...
+
image::ex-nav-asset-versions-engagement.png["The navigation bar with Asset versions engagement option highlighted." option,15%,5%]
+
