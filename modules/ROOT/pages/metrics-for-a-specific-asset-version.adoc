...
Administrators and asset owners with contributor permission can view usage details for specific API specification fragments and REST API assets and each version on the asset details page. 
