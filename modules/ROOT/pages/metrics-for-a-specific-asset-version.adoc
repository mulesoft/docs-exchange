...
Administrators and asset owners with contributor permission can view usage details for a specific API specification fragement and REST API assets and each version on the asset details page. 
