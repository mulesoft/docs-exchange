...
. From the public https://www.anypoint.mulesoft.com/exchange/[Exchange], click an asset and view its description. See the Explore Asset Information section for more information about viewing an asset's detail.
. View the documentation and metadata to learn more about the asset.
. Click *Login* to view assets published into Exchange by your organization.
. After you log in, click *Public Portal* in your organization to view public APIs available to anyone.

After you log in to Exchange, you can create assets.

== Test APIs by Using the Mocking Service

To use the API mocking service for an asset:

. Click *Any Types* > *REST APIs* and choose any API.
. Click the asset and view the list of API functions in the left navigation area.
...
View RAML, OAS, or AsyncAPI API specification information, including resources and the methods in each resource, in the left navigation area.
