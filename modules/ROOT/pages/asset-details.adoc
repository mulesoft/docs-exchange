...
For example, enter the term *ruleset* in the Search content box. Under Pages, there are three search results for ruleset in the Home page. Click *Home* to open the page. Use the arrows to find all of the highlighted instances of ruleset in the Home page.
