...
If you cannot find an asset in the current business group scopes, search in other scopes. In the left navigation bar click *All assets* (assets provided by MuleSoft and your own root organization), *Provided by MuleSoft*, or a business group scope.
