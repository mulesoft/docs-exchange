...
Anypoint Platform products other than Exchange, such as Anypoint Flow Designer or Anypoint Studio, do not consume asset versions in the `development` state.
