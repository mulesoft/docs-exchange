...
WARNING: To create or update Descriptor files manually, your files need to be saved using the correct character encoding format (UTF-8). Encoding problems may occur when the encoding of the Descriptor file doesn't match the expected encoding of API Catalog CLI.
