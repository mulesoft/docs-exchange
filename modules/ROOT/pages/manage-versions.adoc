...
Manage the versions of assets by viewing version detail, adding a new version, deleting a version, and changing the lifecycle state.
...
. Click the 3 dots icon and choose *Version detail* from the menu.
. Click *Close*.

== Add New Version of an Asset

You can add major, minor, and patch versions for an asset. 

. Click *Manage versions* in the expanded asset details pane.
. Click *Add new version*.
. (Required) For APISelect a *Method* for the API specification.
...
. Click *Manage versions* in the expanded asset details pane.
. Click the 3 dots icon and choose *Delete version* from the menu.
. Click *Close*.
