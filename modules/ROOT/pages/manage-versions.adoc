...
. A list of all  available implementations for your current version shows. +
...
. Under *Applied automatic policy status*, you'll see the policies that need updating. Click the more options menu icon and click *See covered APIs* to get a list of the APIs using the incompatible policy. 
