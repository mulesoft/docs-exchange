...
Use categories to organize Exchange assets into groups and improve asset browsing and discovery.
...
To create a category, you must have the role *Exchange Administrator* of the master organization or *Organization Owner* of the master organization.

When you have one or more categories defined in the *Settings* page, your organization's assets display the *Add Category* prompt.
