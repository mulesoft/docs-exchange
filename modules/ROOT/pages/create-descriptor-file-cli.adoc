...
Before you run the commands to publish your APIs, you must create a descriptor file that has the information Exchange needs to catalog the APIs. Typically you create the file using the CLI and update the file manually to set more options to control how the assets are published. 
...
----
+
Following is example descriptor output that is written to the descriptor file:
+
----
...
* xref:create-descriptor-file-manually.adoc#manual-descriptor[Create or Update a Descriptor File Manually]