...
Get an access token with a cURL command such as the following. Optionally, you can use Postman or another application instead of cURL for sending HTTP commands.
