...
### Restricting assets types

It's possible to add a custom field only to certain type of assets. For example, this custom field will only applied to REST APIs:
