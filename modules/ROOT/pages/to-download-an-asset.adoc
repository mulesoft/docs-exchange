...
When you change the asset name, description, or tags of the REST asset, Exchange updates these attributes for the generated connectors.

RAML and OAS versions have been automatically generated for all RAML and OAS assets uploaded since xref:release-notes::exchange/anypoint-exchange-release-notes.adoc#january-2019[January 12, 2019]. If you find an older asset that does not include one of these versions, you can generate all versions by downloading the asset and uploading it again.
