...
+
If you choose As Mule policy, Exchange downloads the policy definition as a jar file containing a YAML file for the definition. If you choose As Policy definition, Exchange downloads the definition as a YAML file.
+
